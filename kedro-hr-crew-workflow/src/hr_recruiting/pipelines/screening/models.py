...
class ScreeningEvaluationOutput(BaseModel):
    """LLM-produced qualitative evaluation and hiring recommendation."""
    ...
    qa_suggestions: list[str] = Field(
        default_factory=list,
        description="QA suggestions for next steps (empty array when recommendation is reject)",
    )
