...
# kedro_batch_agent documentation build
...
from kedro_batch_agent import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_batch_agent"
author = "Kedro"
...
htmlhelp_basename = "kedro_batch_agentdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_batch_agent.tex",
        "kedro_batch_agent Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_batch_agent",
        "Project kedro_batch_agent codebase.",
        "Data-Science",
    )
]
