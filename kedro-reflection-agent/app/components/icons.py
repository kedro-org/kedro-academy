"""Inline SVG icon strings — Lucide icon set, stroke-based.

Usage:
    from app.components.icons import ic
    html = f'<span style="color:#2251FF">{ic("briefcase", size=18)}</span>'

All icons are rendered as inline SVG with currentColor so they inherit
the surrounding text/fill color.
"""
...
_PATHS: dict[str, str] = {
    ...
    "radar": '<path d="M19.07 4.93A10 10 0 0 0 6.99 3.34"/><path d="M4 6.1a10 10 0 0 0-2.29 8.05"/><path d="M15.07 19.07A10 10 0 0 0 21 10"/><path d="M9 21a10 10 0 0 0 5-1.36"/><circle cx="12" cy="12" r="3"/><line x1="12" y1="9" x2="12" y2="2"/>',
...
def ic(name: str, size: int = 16, color: str = "currentColor", extra_style: str = "") -> str:
    """Return an inline SVG string for the given Lucide icon name."""
    paths = _PATHS.get(name, "")
    style = f"vertical-align:middle;flex-shrink:0;{extra_style}"
    return (
        f'<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" '
        f'viewBox="0 0 24 24" fill="none" stroke="{color}" '
        f'stroke-width="2" stroke-linecap="round" stroke-linejoin="round" '
        f'style="{style}">{paths}</svg>'
    )
