...
from agentic_reflection_poc.utils.eval_dataset_format import to_langfuse_items  # noqa: E402
from agentic_reflection_poc.utils.prompt_utils import SEED_PROMPT, SEED_SKILL  # noqa: E402
...
def main() -> None:
    ...
    _write_json(ROOT / "data/synthetic/customers.json", customers)
    _write_json(ROOT / "data/synthetic/products.json", products)
    _write_json(ROOT / "data/synthetic/eval_cases.json", eval_langfuse)
    _write_yaml_prompt(ROOT / "data/prompts/agent_run/campaign_agent_system_prompt.yaml", SEED_PROMPT)
    _write_text(ROOT / "skills/b2b-email-style.md", SEED_SKILL)
