...
from agentic_reflection_poc.pipelines.reflection.diffing import unified_diff_html
from agentic_reflection_poc.utils.eval_dataset_format import from_langfuse_items
from agentic_reflection_poc.base.llm import invoke_text
from agentic_reflection_poc.base.models import (
    AggregateScore,
    CaseScore,
    EvalCase,
    GroundTruth,
)
from agentic_reflection_poc.pipelines.reflection.models import (
    ReflectionChange,
    ReflectionIssue,
    ReflectionProposal,
    ReflectionReason,
...
"""
from agentic_reflection_poc.utils.prompt_utils import is_weak_prompt, load_seed_prompt_yaml, load_seed_skill, prompt_text
...
def _render_summary_md(
    ...
    *,
    ...
    if already_improved:
        lines.append(
            "> **Note:** The active prompt already looks like v2. Use **Reset demo** in the sidebar "
