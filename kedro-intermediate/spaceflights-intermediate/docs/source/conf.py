...
# spaceflights_intermediate documentation build
...
from spaceflights_intermediate import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflights_intermediate"
author = "Kedro"
...
htmlhelp_basename = "spaceflights_intermediatedoc"
...
latex_documents = [
    (
        master_doc,
        "spaceflights_intermediate.tex",
        "spaceflights_intermediate Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflights_intermediate",
        "Project spaceflights_intermediate codebase.",
        "Data-Science",
    )
]
