...
def build_lookup_docs(docs: pd.DataFrame, docs_matches: int = 3) -> FunctionTool:
    @function_tool
...
def build_get_user_claims(db_engine: Engine) -> FunctionTool:
    @function_tool
...
def build_create_claim(db_engine: Engine) -> FunctionTool:
    @function_tool
